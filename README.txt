...
GitHub Plugin URI: seezee/cf7-conditional-load  
...
2. Search for “CF7 Conditional Load”
3. Click “Install Now”
4. Activate the plugin on the Plugin dashboard
5. Go to Settings -> CF7 Conditional Load, upload your fonts, and configure the settings.
...
7. Go to Settings -> CF7 Conditional Load, upload your fonts, and configure the settings.

### USING FTP
1. Download the CF7 Conditional Load ZIP file
2. Extract the CF7 Conditional Load ZIP file to your computer
